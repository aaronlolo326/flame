...
NNODE=${NNODE} NGPU=${NGPU} LOG_RANK=${local_rank} bash train.sh \
  ...
  --training.tokenized_dataset_dir /storage/backup/hei/data/fineweb100bt-qwen3-tokenized-packed-16384_arrow/train \
  --training.streaming \
  ...
  --activation_checkpoint.selective_ac_option 3
