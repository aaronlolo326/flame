...
NNODE=1 NGPU=${NGPU} LOG_RANK=0 bash train.sh \
  ...
  --training.ttt_trainable_patterns ".attn.w0,.attn.w1,.attn.w2,.attn.lr_proj,.attn.qk_scale,.attn.qk_offset,.attn.ttt_scale_proj,.attn.ttt_norm,.attn.momentum_proj" \
