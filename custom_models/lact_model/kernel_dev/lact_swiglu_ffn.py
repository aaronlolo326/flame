...
if __name__ == "__main__":
    ...
    def ref_fwd(W0_W2, W1, X_pad):
        ctx = FakeCtx()
        return FusedSwiGLUFFNFwd.forward(ctx, W0_W2, W1, X_pad)
    ...
    benchmark(varlen_fwd, ref_fwd, (W0_W2, W1, X), (W0_W2, W1, X_pad))
    ...
    def varlen_bwd(W0_W2, W1, X):
        ctx = type('Ctx', (), {'saved_tensors': (W0_W2, W1, X, cu_seqlens, eff_lens, bos_arr), 'max_sl': max_sl_val})()
        return FusedSwiGLUFFNVarlenFwd.backward(ctx, grad_out)[:3]

    def ref_bwd(W0_W2, W1, X_pad):
        ctx = type('Ctx', (), {'saved_tensors': (W0_W2, W1, X_pad)})()
        return FusedSwiGLUFFNFwd.backward(ctx, grad_out_pad)
    ...
    benchmark(varlen_bwd, ref_bwd, (W0_W2, W1, X), (W0_W2, W1, X_pad))
